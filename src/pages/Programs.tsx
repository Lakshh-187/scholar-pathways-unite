  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow pt-20">
        ...
        {/* Why Uniford Scholars Stand Out - Simplified */}
        <section className="py-16 bg-gradient-to-br from-unifor-dark-purple/5 to-unifor-purple/5">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto mb-12">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-6 text-unifor-dark-purple">
                How Uniford Foundation Transforms Students Stuck in Traditional Models
              </h2>
              
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-unifor-purple/20 text-left">
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-unifor-purple mt-2 flex-shrink-0"></div>
                    <p className="text-gray-700">Organization focuses to provide <span className="font-semibold text-unifor-dark-purple">unconditional opportunity & platform</span> along with backing them</p>
                  </div>
                  
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-unifor-purple mt-2 flex-shrink-0"></div>
                    <p className="text-gray-700">The organization provides them a <span className="font-semibold text-unifor-dark-purple">Special Badge Internship</span> along with a <span className="font-semibold text-unifor-dark-purple">"Portfolio Website"</span></p>
                  </div>
                  
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-unifor-purple mt-2 flex-shrink-0"></div>
                    <p className="text-gray-700">Organization provides internship using <span className="font-semibold text-unifor-dark-purple">modern AI-based CFA</span></p>
                  </div>
                  
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-unifor-purple mt-2 flex-shrink-0"></div>
                    <p className="text-gray-700">Organization uses <span className="font-semibold text-unifor-dark-purple">RPO Model</span> means <span className="italic">"Resources to Learn", "Platform to Perform", "Opportunity based on Profile"</span></p>
                  </div>
                  
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-unifor-purple mt-2 flex-shrink-0"></div>
                    <p className="text-gray-700">Organization focuses on <span className="font-semibold text-unifor-dark-purple">unconditional practical exposure, participation, platform & opportunity</span></p>
                  </div>
                  
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-unifor-purple mt-2 flex-shrink-0"></div>
                    <p className="text-gray-700">Using profile screening organization connects students with <span className="font-semibold text-unifor-dark-purple">worldwide opportunity</span> by referral, LOR & recommend their profile</p>
                  </div>
                  
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-unifor-purple mt-2 flex-shrink-0"></div>
                    <p className="text-gray-700">Organization focuses that every student has <span className="font-semibold text-unifor-dark-purple">initiative & high participation</span> like internship, competitions</p>
                  </div>
                </div>

                {/* Simple Call to Action */}
                <div className="text-center mt-8 pt-6 border-t border-gray-200">
                  <p className="text-unifor-dark-purple font-semibold mb-4">Ready to break free from traditional limitations?</p>
                  <div className="flex flex-wrap justify-center gap-4">
                    ...
                    <Button variant="outline" className="border-unifor-purple text-unifor-purple hover:bg-unifor-purple hover:text-white">
                      Learn More
                    </Button>
                  </div>
                </div>
