...
const formSchema = z.object({
  ...
  scholarId: z.string().min(2, { message: 'Please enter your Scholar ID.' }),
  submissionFor: z.string().min(2, { message: 'Please mention what you’re submitting for.' }),
  projectLink1: z.string().url({ message: 'Please provide a valid Project Link (1).' }),
  projectLink2: z.string().url({ message: 'Please provide a valid Project Link (2).' }),
  websiteLink: z.string().optional(),
  whatsapp: z.string().regex(/^\d{10}$/, { message: 'Invalid phone number format (10 digits).' }),
  session: z.enum(['Winter Session', 'Summer Session'], {
...
const IDCardApplicationForm: React.FC = () => {
  ...
  const onSubmit = (data: FormValues) => {
    ...
    const scriptUrl = 'https://script.google.com/macros/s/AKfycbyRKXZ6dRlcTHLmvbx0RoJ6FV3APs1PY1iLvTM_IpIsOXgmdlsKogtfGZjr96Ejjo47CA/exec'; // Explicitly set the correct URL
    ...
    formData.append('submissionFor', data.submissionFor);
    formData.append('projectLink1', data.projectLink1);
    formData.append('projectLink2', data.projectLink2);
    ...
    <section id="registration" className="py-20 bg-gradient-to-b from-white to-[#f5f2ff]">
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Submission</h2>
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Submission  For (eg. Internship , Project Expo ...) *</FormLabel>
                        <FormControl>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Website Link / Verified Badge ( optional)</FormLabel>
                        <FormControl>
                          <Input placeholder="Share Link" {...field} />
                        </FormControl>
                        <FormMessage />
                      ...
                      <FormControl>
                        ...
                        >
                          <FormItem className="flex items-center space-x-3 space-y-0">
                            <FormControl>
                              <RadioGroupItem value="Winter Session" />
                            </FormControl>
                            <FormLabel className="font-normal">Winter Session</FormLabel>
                          </FormItem>
                          <FormItem className="flex items-center space-x-3 space-y-0">
                            <FormControl>
                              <RadioGroupItem value="Summer Session" />
                            </FormControl>
