...
export const formSchema = z.object({
  ...
  session: z.enum(["Winter", "Summer"], {
    required_error: "Select a session (Winter/Summer)."
  }),

  applicationType: z.enum([
    "Potential Hunter",
    "Go Green Planet Campaign",
    "Social Welfare Mentor",
    "Collect for Cancer Patients",
    "Blood Donation Drive",
    "Donate STEM Kits",
    "Donate Innovation"
  ], {
    required_error: "Please select one application type."
  }),
...
const IDCardApplicationForm: React.FC = () => {
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: {
      ...
      location: "",
      whatsapp: "",
      session: "Winter", // or default to ""
      applicationType: "Potential Hunter", // or default to ""
      category: "",
      termsAgreed: true,
    }
  });
  ...
  const onSubmit = (data: FormValues) => {
    ...
    const scriptUrl = 'https://script.google.com/macros/s/AKfycbwS14pxYWFsarVCuwHPn2nk0XvdyRwOWRFEoZz6en0tVeI2zMHhKrtfS3gL_KVIxl2a/exec'; // Explicitly set the correct URL
    ...
    <section id="registration" className="py-20 bg-gradient-to-b from-white to-[#f5f2ff]">
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Social Internship </h2>
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel> Location (Country , City ,state) *</FormLabel>
                        <FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="space-y-3">
                      <FormLabel>You Are Applying</FormLabel>
                      <FormControl>
                        <RadioGroup
                        ...
                        >
                          <FormItem className="flex items-center space-x-3 space-y-0">
                            <FormControl>
                              <RadioGroupItem value="Winter" />
                            </FormControl>
                            <FormLabel className="font-normal">Winter Session</FormLabel>
                          </FormItem>
                          <FormItem className="flex items-center space-x-3 space-y-0">
                            <FormControl>
                              <RadioGroupItem value="Summer" />
                            </FormControl>
                            <FormLabel className="font-normal">Summer Session</FormLabel>
                          </FormItem>
                        </RadioGroup>
                      </FormControl>
                      <FormMessage />
                    ...
                    <FormItem className="space-y-3">
                      ...
                      <FormControl>
                        ...
                        >
                          <FormItem className="flex items-center space-x-3 space-y-0">
                            <FormControl>
                              <RadioGroupItem value="Potential Hunter" />
                            </FormControl>
                            <FormLabel className="font-normal">Campaign - Potential Hunter</FormLabel>
                          </FormItem>
                          <FormItem className="flex items-center space-x-3 space-y-0">
                            <FormControl>
                              <RadioGroupItem value="Go Green Planet Campaign" />
                            </FormControl>
                            <FormLabel className="font-normal">Go Green Planet Campaign</FormLabel>
                          </FormItem>
                          <FormItem className="flex items-center space-x-3 space-y-0">
                            <FormControl>
                              <RadioGroupItem value="Social Welfare Mentor" />
                            </FormControl>
                            <FormLabel className="font-normal">Social Welfare Mentor</FormLabel>
                          </FormItem>
                          <FormItem className="flex items-center space-x-3 space-y-0">
                            <FormControl>
                              <RadioGroupItem value="Collect for Cancer Patients" />
                            </FormControl>
                            <FormLabel className="font-normal">Collect for Cancer Patients</FormLabel>
                          </FormItem>
                          <FormItem className="flex items-center space-x-3 space-y-0">
                            <FormControl>
                              <RadioGroupItem value="Blood Donation Drive" />
                            </FormControl>
                            <FormLabel className="font-normal">Blood Donation Drive</FormLabel>
                          </FormItem>
                          <FormItem className="flex items-center space-x-3 space-y-0">
                            <FormControl>
                              <RadioGroupItem value="Donate STEM Kits" />
                            </FormControl>
                            <FormLabel className="font-normal">Donate STEM Kits</FormLabel>
                          </FormItem>
                          <FormItem className="flex items-center space-x-3 space-y-0">
                            <FormControl>
                              <RadioGroupItem value="Donate Innovation" />
                           </FormControl>
                            <FormLabel className="font-normal">Donate Innovation</FormLabel>
                          </FormItem>
                        </RadioGroup>
                      </FormControl>
                      <FormMessage />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Category You are applying</FormLabel>
                      <FormControl>
