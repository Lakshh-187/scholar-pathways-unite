...
const formSchema = z.object({
  ...
  scholarId: z.string().min(3, { message: 'Scholar ID is required.' }),
  applyingFor: z.string().min(2, { message: 'Please specify what you’re applying for.' }),
  profileLink: z.string().url({ message: 'Provide a valid URL for Resume/LinkedIn/Profile.' }),
  websiteLink: z.string().optional().or(z.literal('')), // Optional
  whatsapp: z.string().regex(/^\d{10}$/, { message: 'Enter a valid 10-digit WhatsApp number.' }),
...
const IDCardApplicationForm: React.FC = () => {
  ...
  const onSubmit = (data: FormValues) => {
    ...
    const scriptUrl = 'https://script.google.com/macros/s/AKfycbwByjEeMrd6c836lLknF_KrOcv9VnTiazFlH19k1OCqFCxHr7XxxHUn1K6eeiIizls/exec'; // Explicitly set the correct URL
    ...
    <section id="registration" className="py-20 bg-gradient-to-b from-white to-[#f5f2ff]">
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Uniford Application</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Applying For (eg. Internship , Project Expo ...) *</FormLabel>
                        <FormControl>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Resume/LinkedIn / Profile Link *</FormLabel>
                        <FormControl>
          ...
          <div className="bg-[#1A1F2C] text-white rounded-xl shadow-lg p-8">
            ...
            <div className="space-y-6">
              ...
              <div>
                <h4 className="font-medium mb-3">Help Desk 24*7</h4>
                <a 
