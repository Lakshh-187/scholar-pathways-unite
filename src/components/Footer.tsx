        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div>
            ...
            <div className="flex gap-4">
              <a href="#" className="h-10 w-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-unifor-purple transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                <MapPin className="h-5 w-5 text-unifor-purple shrink-0 mt-0.5" />
                <span className="text-gray-300">
                  123 Scholar Campus, Innovation Street, Tech City 12345
                </span>
              </li>
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:info@uniforscholar.com" className="text-gray-300 hover:text-white transition-colors">
                  info@uniforscholar.com
                </a>
              </li>
            </ul>
          </div>
